...
import './App.css';
  ...
  return (
    <>
      <ul>
        <li className="title" >1º Andar</li>
         {
           floor1.map(item => ( 
            <>
              <img key={item.RoomID} id={item.NumberRoom} src={`https://becocastelo.com/public/front/img/${item.NameImage}`} />  
             <li>{item.NumberRoom}</li>
            </>
           ))
         }
      </ul>
      <ul>
        <li className="title" >2º Andar</li>
        {
           floor2.map(item => ( 
            <>
              <img key={item.RoomID} id={item.NameImage} src={`https://becocastelo.com/public/front/img/${item.NameImage}`} />  
             <li>{item.NumberRoom}</li>
            </>
           ))
         }
      ...
      <ul>
        <li className="title" >3º Andar</li>
        {
           floor3.map(item => ( 
            <>
              <img id={item.NameImage} src={`https://becocastelo.com/public/front/img/${item.NameImage}`} />  
             <li>{item.NumberRoom}</li>
            </>
           ))
         }
      ...
      <ul>
        <li className="title" >4º Andar</li>
        {
           floor4.map(item => ( 
            <>
              <img id={item.NameImage} src={`https://becocastelo.com/public/front/img/${item.NameImage}`} />  
      ...
      <ul>
        <li className="title" >5º Andar</li>
        {
           floor5.map(item => ( 
            <>
              <img id={item.NameImage} src={`https://becocastelo.com/public/front/img/${item.NameImage}`} />  
      ...
      <ul>
        <li className="title" >6º Andar</li>
        {
           floor6.map(item => ( 
            <>
              <img id={item.NameImage} src={`https://becocastelo.com/public/front/img/${item.NameImage}`} />  
      ...
      <ul>
        <li className="title" >7º Andar</li>
        {
           floor7.map(item => ( 
            <>
              <img id={item.NameImage} src={`https://becocastelo.com/public/front/img/${item.NameImage}`} />  
      ...
      <ul>
        <li className="title" >8º Andar</li>
        {
           floor8.map(item => ( 
            <>
              <img id={item.NameImage} src={`https://becocastelo.com/public/front/img/${item.NameImage}`} />  
      ...
      <ul>
        <li className="title" >9º Andar</li>
        {
           floor9.map(item => ( 
            <>
              <img id={item.NameImage} src={`https://becocastelo.com/public/front/img/${item.NameImage}`} />  
      ...
      <ul>
        <li className="title"> 10º Andar</li>
        {
           floor10.map(item => ( 
            <>
              <img id={item.NameImage} src={`https://becocastelo.com/public/front/img/${item.NameImage}`} />  
      ...
      <ul>
        <li className="title"> 11º Andar</li>
        {
           floor11.map(item => ( 
            <>
              <img id={item.NameImage} src={`https://becocastelo.com/public/front/img/${item.NameImage}`} />  
